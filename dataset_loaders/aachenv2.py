...
if __name__ == '__main__':
    ...
    ax.scatter3D(x[:,0],x[:,2],x[:,1], s = 0.5, alpha = 0.2)
    ax.set_xlim3d(median[0]-thresh,median[0]+thresh)
    ax.set_ylim3d(median[2]-thresh,median[2]+thresh)
    ax.set_zlim3d(median[1]-thresh,median[1]+thresh)
    plt.show()